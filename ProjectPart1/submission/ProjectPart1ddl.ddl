...
CREATE TABLE ml_oz_member (
	...
	assocaitedairline  VARCHAR2(30) NOT NULL,
...
CREATE TABLE ml_oz_passenger_flight (
    mealplan    VARCHAR2(30) NOT NULL,
    cabinclass  VARCHAR2(30) NOT NULL,
    passengerid NUMBER(6) NOT NULL,
    flightid    NUMBER(6) NOT NULL
);
...
CREATE TABLE ml_oz_passenger_request (
    passengerid      NUMBER(6) NOT NULL,
    specialrequestid NUMBER(6) NOT NULL
);
...
CREATE TABLE ml_oz_purchase (
    ...
    coveragefname VARCHAR2(30) NOT NULL,
    coveragelname VARCHAR2(30) NOT NULL,
    planid        NUMBER(6) NOT NULL,
    invoicenumber NUMBER(6) NOT NULL,
	flightid      NUMBER(6) NOT NULL,
	passengerid   NUMBER(6) NOT NULL
...
COMMENT ON COLUMN ml_oz_purchase.purchaseid IS
...
ALTER TABLE ml_oz_purchase ADD CONSTRAINT ml_oz_purchase_pk PRIMARY KEY ( purchaseid );

CREATE TABLE ml_oz_specialrequest (
    specialrequestid   NUMBER(6) NOT NULL,
    specialrequestname VARCHAR2(30) NOT NULL
);
...
ALTER TABLE ml_oz_airline_model
    ADD CONSTRAINT fk_airline_model_airline FOREIGN KEY ( airid )
